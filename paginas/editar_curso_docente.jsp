...
<body>
    ...
    %>
                    ...
                    <form action="atualizar_curso_docente.jsp" method="POST">
                        ...
                        <select name="idDocente" id="idDocente">
                            <% 
                                ...
                                String sqlDocentes = "SELECT idUtilizador, nomeUtilizador FROM utilizador WHERE idUtilizador = ?";
                                psDocente = conn.prepareStatement(sqlDocentes);
                                psDocente.setInt(1, idDocente);
                        ...
                        <select name="tipoCurso" id="tipoCurso">
                            <% 
                                // Busca tipos de curso no banco de dados
                        ...
                        <select name="estadoCurso" id="estadoCurso">
                            <% 
                                // Busca estados de curso no banco de dados

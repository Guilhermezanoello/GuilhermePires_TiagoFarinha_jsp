...
<body>
    ...
    %>
                <tr>
                    ...
                    <td><%= esdadoDesc %></td>
                    <td>
                        <form id="editar_inscricao" action="editar_curso.jsp" method="POST" style="display:inline;">
                            <input type="hidden" name="id_curso" value="<%= rs.getString("id_curso") %>">
                            <input type="submit" value="Editar">
                        </form>
                        |
                        <form id="excluir_inscricao" action="excluir_curso.jsp" method="POST" style="display:inline;">
                            <input type="hidden" name="id_curso" value="<%= rs.getString("id_curso") %>">
    ...
    %>
    <button onclick="location.href='adicionar_cursos.jsp'">Adicionar Cursos</button>
    <div id="footer">

...
<body>
    ...
    <% 
    try {
        String sql = "SELECT * FROM inscricoes WHERE id_aluno = ? ORDER BY id_curso DESC, v_exam_nacional DESC";
    ...
    %>
                <tr>
                    ...
                    <td><%= esdadoDesc %></td>
                    <td>                        
                        <form id="editar_inscricao" action="editar_inscricao_aluno.jsp" method="POST" style="display:inline;">
                            <input type="hidden" name="id_inscricao" value="<%= rs.getString("id_inscricao") %>">
                            <input type="submit" value="Editar">
                        </form>
                        |
                        <form id="excluir_inscricao" action="excluir_inscricao_aluno.jsp" method="POST" style="display:inline;">
                            <input type="hidden" name="id_inscricao" value="<%= rs.getString("id_inscricao") %>">
    ...
    %>
    <button onclick="location.href='adicionar_inscricao_aluno.jsp'">Adicionar Inscrição</button>
    <div id="footer">

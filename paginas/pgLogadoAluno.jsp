...
<body>
    ...
    <div id="section">
        ...
        <div class="article">
            <h1></h1>
            <button onclick="location.href='gestao_inscricoes_aluno.jsp'">Gestão de Inscrições</button>
            <p></p>
        </div>
        <div class="article">
            <h1></h1>

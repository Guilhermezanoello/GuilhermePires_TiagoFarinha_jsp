...
<%
    ...
    if (aluno == null || curso == null || data_inscricao == null || v_exam_nacional == null || status_inscricao == null ||
        ...
        out.println("<meta http-equiv='refresh' content='0; url=adicionar_inscricao.jsp'>");
        return;
    }
    ...
    // Contar o número de inscrições aprovadas para o curso selecionado
    int numAprovadas = 0;
    try {
    ...
    // Buscar o limite de alunos do curso selecionado
    int limiteAlunos = 0;
    try {
    ...
    // Verificar se o número de inscrições aprovadas é menor ou igual ao limite de alunos
    ...
    // Verificar se o aluno já possui uma inscrição ativa para o curso selecionado
    try {
    ...
    // Inserir a nova inscrição no banco de dados
    try {
